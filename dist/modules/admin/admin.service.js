...
const updateUserStatus = async (adminId, adminRole, userId, status) => {
...
const createCategory = async (adminRole, name) => {
    if (adminRole !== Role.ADMIN)
...
const updateCategory = async (adminRole, id, name) => {
    if (adminRole !== Role.ADMIN)
...
const deleteCategory = async (adminRole, id) => {
    if (adminRole !== Role.ADMIN)
...
const getAdminDashboardStats = async () => {
    const [totalUsers, totalStudents, totalTutors, activeUsers, bannedUsers, totalCategories, totalTutorProfiles, totalBookings, bookingStats, totalReviews, avgRating, recentBookings,] = await Promise.all([
        prisma.user.count(),
